...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        while(opcao != 0) {
            ...
            var menu = """
                    ...
                    8 - Filtrar séries
                    9 - Buscar de episódios por trecho
    ...
    private void buscarEpisodioPorSerie(){
        ...
        if(serie.isPresent()){
            var serieEnocntrada = serie.get();
            List<DadosTemporada> temporadas = new ArrayList<>();

            for (int i = 1; i <= serieEnocntrada.getTotalTemporadas(); i++) {
                var json = consumo.obterDados(ENDERECO + serieEnocntrada.getTitulo().replace(" ", "+") + "&season=" + i + API_KEY);
            ...
            serieEnocntrada.setEpisodios(episodios);
            repositorio.save(serieEnocntrada);
        }else{
